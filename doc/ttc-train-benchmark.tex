...
the runtimes of the FunnyQT solutions for all models up to the size of 8192
(12,512,663 elements, 23,048,272 references) and the fixed and proportional
strategies when being run by the train benchmark framework.  The measurements
have been performed on an 2.7 GHz 8-core machine with 16 GB of RAM being
