...
It matches a \code|Route| with its entry semaphore where the semaphore's signal
is \code|Signal.GO|.  The route follows some switch position whose switch's
current position is different from that of the switch position.
